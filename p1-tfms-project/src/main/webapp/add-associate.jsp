...
<body class="bg-light">
   ...
   <!-- ======= Header ======= -->
			...
			<nav id="navbar" class="navbar order-last order-lg-0">
				<ul>
					...
					<li class="dropdown"><a href="#"><span> provision</span> <i
						...
						<ul>
							<li><a href="add-associate.jsp">Add Associate</a></li>
							<li class="dropdown"></li>
							<li><a href="delete-edit-associate.jsp">Show Associate</a></li>
						</ul></li>
				</ul>
	...
	<div class="container pt-4" style="margin-top: 7%;">
		<div class="row">
			<div class="col-md-6 offset-md-3">
				<div class="card">
					<div class="card-body">
						<p class="fs-3 text-center">Add Associate</p>
						...
						<form action="add-associate" method="post">
							<div class="mb-3">
								<label for="exampleInputEmail1" class="form-label">Associate
									Id</label> <input type="text" class="form-control"
									id="exampleInputEmail1" aria-describedby="emailHelp"
									name="associate-id" />
							</div>
							<div class="mb-3">
								<label for="exampleInputPassword1" class="form-label">Associate
							...
							<div class="col-md-6 mb-4">
								...
								<select class="select"
									style="width: 589px; padding: 13px 10px; border-radius: 5px; color: rgb(23, 18, 18); margin-left: -13px;"
									name="track">
							...
							<button type="submit" class="btn btn-primary col-md-12" style="background-color: #5fcf80;">Submit</button>
						</form>
					</div>
				</div>
			</div>
