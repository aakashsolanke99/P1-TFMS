...
<title>delete-edit Associates</title>
...
<body
	...
	<main id="main" style="margin-top: 6%; margin-left: 6%">
		<div class="container p-3">
			<div class="card">
				<div class="card-body">
					<p class="text-center fs-1">All Associate Details</p>
	...
	<footer id="footer">
					...
					<div class="col-lg-3 col-md-6 footer-links">
						...
						<ul>
							<li><i class="bx bx-chevron-right"></i> <a
								href="add-associate.html">Add Associate</a></li>
							<li><i class="bx bx-chevron-right"></i> <a
								href="delete-edit-associate.html">Show Associate</a></li>
		...
		<div class="container d-md-flex py-4">
			<div class="me-md-auto text-center text-md-start">
				<div class="copyright">
					&copy; Copyright <strong><span>Associate</span></strong>. All
					Rights Reserved
				</div>
				<div class="credits">
