...
<html lang="en">
  <head>
    ...
    <title>index Associate - Index</title>
  ...
  <body>
    ...
    <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center">
        ...
        <a href="loginaPage.jsp" class="get-started-btn">LogIn</a>
      </div>
    </header>
    <!-- End Header -->
    ...
    <section id="hero" class="d-flex justify-content-center align-items-center">
      ...
      >
        ...
        <a href="loginaPage.jsp" class="btn-get-started">LogIn</a>
      </div>
    </section>
    <!-- End Hero -->
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-2 col-md-6 footer-links">
              ...
              <ul>
                <li>
                  <i class="bx bx-chevron-right"></i> <a href="home.html">Home</a>
                </li>
                <li>
            ...
            <div class="col-lg-3 col-md-6 footer-links">
              ...
              <ul>
                <li>
                  <i class="bx bx-chevron-right"></i> <a href="add-associate.html">add associate</a>
                </li>
                <li>
                  <i class="bx bx-chevron-right"></i>
                  <a href="delete-edit-associate.html">delete or edit associate</a>
                </li>
              </ul>
            </div>
